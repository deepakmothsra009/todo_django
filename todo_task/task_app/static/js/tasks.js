...
function App() {
	...
	const saveTask = (e)=>{
		...
		if (title.length === 0)
			...
			if (taskId === null)
				post_task_api({title, description, status}, ()=>{getData();});
			else
				put_task_api(taskId, {title, description, status}, ()=>{getData();});
			setShowModal(false);
		}
	};
					...
					<form method="post">
						<div className="modal-content">
							...
							<div className="modal-body">
								...
								<div className="form-group">
									<input type="text" className="form-control" name="description" id="itemInput"
